...
<head>
    ...
    <script>
        const BASE_URL_APP = '<?php echo BASE_URL_PROJECT; ?>';
    </script>
    </head>
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="<?php echo BASE_URL_PROJECT; ?>/home" class="nav-link"><i class="fas fa-home"></i> INICIO</a>
                </li>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="<?php echo BASE_URL_PROJECT; ?>/perfil" class="d-block"><?php echo strtoupper(htmlspecialchars($_SESSION['usuario']['nombre'])); ?></a>
                    </div>
                </div>
                <?php endif; ?>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo BASE_URL_PROJECT; ?>/empleado" class="nav-link">
