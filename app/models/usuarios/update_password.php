...
require_once __DIR__ . '/../sql/bitacora.php'; // Para registrar acción en bitácora
...
try {
    ...
    // Antes de actualizar, construir infoAnterior (sin incluir el hash real)
    $infoAnterior = ['id_usuario' => $userId];
    ...
    // Construir infoPosterior indicando cambio de contraseña
    $infoPosterior = ['id_usuario' => $userId, 'contrasena' => '****cambiada****'];

    // Registrar en bitácora que se actualizó contraseña del usuario
    registrarBitacora(
        'usuarios',
        $userId,
        'UPDATE',
